...
APPKIT_EXTERN	NSString *AMGroupIncomingName;
APPKIT_EXTERN	NSString *AMGroupProxyName;

//session types
enum
{
	AMSessionOutgoingTunnel	= 0,
	AMSessionIncomingTunnel	= 1,
	AMSessionGlobalProxy	= 2,
	AMSessionCategory		= 3
};